...
function tableNavClicked(p_tableName, p_pageNum, ns, p_tablePos, tblid){
 ...
 var tableNavMode = prefixCompID(ns, p_tableName, "TABLE_NAV__") + tableName + "__BTN_" + p_pageNum + "__ID__" + encodeParam(ns + stripPrefix(ns, tblid));
 var scrollToAnchorId = "_TABLE_" + tblid; // ANCHOR will get pre-pended to it
 ecSubmitForm(ns, tableNavMode, true, scrollToAnchorId );
}
