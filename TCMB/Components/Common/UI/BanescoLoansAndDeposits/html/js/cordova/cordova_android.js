    ...
    fireDocumentEvent: function(type, data, bNoDetach) {
        ...
        if (typeof documentEventHandlers[type] != 'undefined') {
            if( bNoDetach ) {
                ...
                setTimeout(function() {
                    // Fire deviceready on listeners that were registered before cordova_android.js was loaded.
                    if (type == 'deviceready') {
...
// Wrap in a setTimeout to support the use-case of having plugin JS appended to cordova_android.js.
