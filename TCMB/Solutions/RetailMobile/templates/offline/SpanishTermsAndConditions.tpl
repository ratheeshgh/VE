<div class="Justify tac-style">
<div class="BColorWhite Padding5">
<h4 class=" tac-head">CONDICIONES GENERALES DEL SERVICIO BANESCOMÓVIL</h4>

<h4 class=" tac-head">PRIMERA:</h4>
...
<h4 class=" tac-head">TERCERA: </h4>
<p>El BANCO está de acuerdo en prestar y el CLIENTE en hacer uso del SERVICIO, para efectuar las transacciones financieras a través del dispositivo móvil, conforme a las Cláusulas de este Contrato. En virtud de lo anterior el CLIENTE deberá: (i) ser titular de CUENTAS y/o TARJETAS DE CRÉDITO en el BANCO; (ii) poseer un dispositivo móvil habilitado técnicamente para tener acceso al SERVICIO; y, (iii) cumplir con cualquier otro requisito que pudiera solicitar el BANCO para hacer uso del SERVICIO, todo de conformidad con lo establecido en las instrucciones que serán impartidas por el propio sistema. </p>

<h4 class=" tac-head">CUARTA: </h4>
<p>El CLIENTE podrá afiliarse al SERVICIO a través de los siguientes canales: (i) BANESCONLINE; (ii) Mensaje de Texto + IVR, así como cualquier otro canal que el BANCO pudiere habilitar para ello. Durante el proceso de afiliación el CLIENTE deberá aceptar las presentes Condiciones Generales, las cuales se encontrarán disponibles a través del propio sistema, así como en BANESCONLINE, en la página web del BANCO www.banesco.com, o a través de cualquier otro dominio que el BANCO disponga para tal fin, así como, en las oficinas del BANCO.</p>

<h4 class=" tac-head">QUINTA: </h4>
<p>El CLIENTE una vez afiliado al SERVICIO, podrá ejecutar las siguientes transacciones financieras, únicamente desde el número del dispositivo móvil previamente afiliado al SERVICIO: (i) Consulta de saldo en CUENTA; (ii) Consulta de últimos movimientos en CUENTA; (iii) Consulta de saldo de la Tarjeta de Crédito; (iv) Consulta de últimos movimientos de la Tarjeta de Crédito; (v) Consulta de saldo de servicios; (vi) Transferencia entre CUENTAS del mismo titular; (vii) Transferencia a CUENTAS de terceros previamente afiliados al SERVICIO; (viii) Pago de Tarjeta de Crédito; (xix) Pago de Tarjeta de Crédito de terceros previamente afiliados al SERVICIO; (xx) Pago de servicios; (xxi) Consulta Operaciones Cambiarias; (xxii) Retiros por Cajeros Automáticos (ATM), entre otras transacciones financieras que el BANCO pudiera incorporar a este SERVICIO, todo lo cual será debidamente informado a los CLIENTES a través del propio sistema, así como cualquier otro medio dispuesto por el BANCO para tales fines.</p>

<h4 class=" tac-head">SEXTA: </h4>
<p>El CLIENTE no podrá afiliar más de un número de dispositivo móvil al SERVICIO, en el entendido que, sólo podrá realizar transacciones financieras, desde el número del dispositivo móvil afiliado. </p>

<h4 class=" tac-head">SÉPTIMA: </h4>
<p>El CLIENTE podrá establecer los montos máximos diarios o mensuales de las transacciones financieras que ejecutará a través del SERVICIO de conformidad con lo dispuesto en la normativa aplicable, y en ningún caso dichos montos podrán ser superiores a los establecidos e informados por el BANCO.</p>

<h4 class=" tac-head">OCTAVA: </h4>
<p>Para el acceso o ejecución de las transacciones financieras, así como a determinados niveles o tipos de funciones, u operaciones, el sistema podrá requerir claves especiales. Las claves tendrán carácter personal, confidencial e intransferible, el BANCO no tendrá conocimiento alguno de las mismas, y su finalidad es garantizar el exclusivo acceso del CLIENTE y las personas por él autorizadas al sistema, en caso que resulte aplicable, siendo responsabilidad exclusiva de éste la guarda, cuido y custodia de sus claves, asumiendo el CLIENTE la obligación de mantener las mismas en estricta confidencialidad y reserva; y, en aquellos casos en los cuales voluntaria o involuntariamente considere que se ha violado la confidencialidad o reserva de las claves, deberá solicitar inmediatamente al BANCO el bloqueo de las mismas. El CLIENTE asumirá en forma exclusiva cualquier responsabilidad derivada o que pudiera derivarse directa o indirectamente de cambios en cualquiera de sus claves, así como del nivel de seguridad empleado por éste, tanto en la composición de las mismas, como en el manejo de sus claves para la realización de transacciones financiera. En virtud de lo establecido en la presente Cláusula, el BANCO no asumirá responsabilidad alguna por cualquier circunstancia derivada, directa o indirectamente, del conocimiento y eventual uso de cualesquiera de las claves del CLIENTE por parte de terceros, por cualquier motivo que ello ocurriere, asumiendo el CLIENTE cualquier responsabilidad al respecto. El CLIENTE se compromete hacer uso del SERVICIO con la debida diligencia, asumiendo los riesgos y responsabilidades de permitir a terceras personas la utilización o manipulación de los equipos telefónicos y sistemas a través de los cuales se acceda al SERVICIO, en consecuencia todas las consultas, transacciones financieras, instrucciones, solicitudes y comunicaciones enviadas a través del SERVICIO, debidamente realizadas a través del uso de las claves del CLIENTE, serán consideradas como emanadas de éste.</p>

<h4 class=" tac-head">NOVENA: </h4>
<p>El CLIENTE podrá limitar o suprimir su acceso a determinadas funciones u opciones del SERVICIO, en los casos en que ello fuere técnicamente permitido en función de las posibilidades del sistema y con las limitaciones que el BANCO tenga establecidas, siguiendo los procedimientos y normas que el BANCO señale a tales fines. El BANCO se reserva el derecho de limitar, restringir o suprimir el acceso del CLIENTE a determinadas funciones u opciones, todo lo cual será informado al CLIENTE a través del propio sistema.</p>

<h4 class=" tac-head">DÉCIMA: </h4>
<p>Los equipos telefónicos, sistemas, programas de navegación por Internet y cualquier otro programa requerido para poder disfrutar del SERVICIO, serán adquiridos y utilizados por el CLIENTE a su costo y riesgo, y deberán tener las características técnicas necesarias para permitir el acceso al SERVICIO. El BANCO no será responsable en ningún caso por el buen funcionamiento, idoneidad, capacidad y compatibilidad de los equipos telefónicos, sistemas y programas adquiridos o utilizados por el CLIENTE a los efectos de hacer uso del SERVICIO.</p>

<h4 class=" tac-head">DÉCIMA PRIMERA: </h4>
<p>El CLIENTE deberá ejecutar las transacciones financiera disponibles a través del SERVICIO de conformidad con lo establecido en las instrucciones contenidas en el sistema, en las presentes Condiciones Generales y en cualquier regulación aplicable a cada una de las operaciones que puedan ejecutarse a través del SERVICIO, en virtud de lo anterior, el BANCO queda exento de cualquier responsabilidad por el no procesamiento de cualesquier transacción financiera enviada a través del SERVICIO que no cumplan con las instrucciones impartidas.</p>

<h4 class=" tac-head">DÉCIMA SEGUNDA: </h4>
<p>En caso de ser necesario por razones de orden técnico, de seguridad, así como por mantenimiento del sistema, el BANCO se reserva el derecho de suspender temporalmente el SERVICIO. Asimismo, el BANCO no se hace responsable por la interrupción imprevista del SERVICIO, por dificultades en su funcionamiento, o por retardo en el tiempo de procesamiento de cualesquier transacción financiera causadas por fallas técnicas, fallas en el servicio eléctrico, en el servicio telefónico, congestionamiento en la Red, o por cualesquiera otras causas ajenas a la voluntad del BANCO.</p>

<h4 class=" tac-head">DÉCIMA TERCERA: </h4>
<p>Las tarifas y/o comisiones que se generen con motivo de la prestación del SERVICIO, así como, por las transacciones financieras que se realicen a través del mismo, serán establecidas por el BANCO de conformidad con la normativa legal vigente que regula la materia, y serán del conocimiento del CLIENTE a través de la información disponible en el propio sistema, así como, por cualquier otro medio que el BANCO determine a tales fines, de manera que permita al CLIENTE el conocimiento exhaustivo de las mismas. El BANCO queda autorizado para debitar o hacer debitar dichas tarifas y/o comisiones, en cualquier cuenta de depósito o inversión que el CLIENTE posea en el BANCO.</p>

<h4 class=" tac-head">DÉCIMA CUARTA: </h4>
<p>El valor del mensaje de texto genera un costo por parte del operador de telefonía móvil celular, a través del medio de pago escogido por el CLIENTE cuando contrató con éste. En virtud de lo anterior, el BANCO no tiene ninguna responsabilidad ni injerencia en la fijación del mismo. En tal sentido, el BANCO queda exonerado de cualquier tipo de responsabilidad derivada de tal circunstancia.</p>

<h4 class=" tac-head">DÉCIMA QUINTA: </h4>
<p>El BANCO podrá suspender en cualquier momento, la prestación del SERVICIO a aquellos CLIENTES que incumplan lo establecido en las presentes Condiciones Generales. Por su parte, el CLIENTE podrá requerir su desafiliación al SERVICIO cuando así lo decidiere, a cuyo efecto deberá manifestar por escrito al BANCO su decisión, quedando, no obstante, bajo la responsabilidad del CLIENTE, cualquier transacción financiera que se realice antes de su efectiva desafiliación al SERVICIO.</p>

<h4 class=" tac-head">DÉCIMA SEXTA: </h4>
<p>El CLIENTE es responsable tanto de  poseer activo el servicio de telefonía celular en el número indicado al momento de afiliarse al SERVICIO, así como de la custodia de su equipo móvil celular, para evitar que terceros no autorizados hagan uso indebido del SERVICIO. En este sentido, el CLIENTE es y será el único responsable por el resguardo del dispositivo móvil adscrito al SERVICIO, y por ende de la confidencialidad de la información que a través del mismo se reciba sobre las transacciones o cualquier otra información que constituya el objeto del SERVICIO. En caso de robo, hurto o extravío del dispositivo móvil cuyo número se encuentra afiliado al SERVICIO, el CLIENTE deberá notificarlo de manera inmediata a fin de proceder a la suspensión del SERVICIO, a través de los medios dispuestos por el BANCO para tal fin. En virtud de lo cual, el BANCO no asume ningún tipo de responsabilidad por el alcance que pudieran tener terceras personas a la información transmitida a través de este SERVICIO derivada del acceso al dispositivo móvil y del uso que hagan de la misma, así como, de la información que pudiera tener almacenada en dicho dispositivo. El CLIENTE se compromete actualizar la información necesaria en caso de efectuar algún cambio en el número telefónico afiliado al SERVICIO, así como cualquier información requerida para su uso.</p>

<h4 class=" tac-head">DÉCIMA SÉPTIMA: </h4>
<p>El BANCO no asumirá responsabilidad alguna por error en que incurriera el CLIENTE, al no indicar correctamente los datos requeridos para efectuar las transacciones financieras, en especial, no asumirá responsabilidad alguna si por esta circunstancia se imputara el pago o transferencia a una CUENTA o TARJETA DE CRÉDITO distinta a la que originalmente tenía previsto realizar la transacción. Asimismo, el BANCO no asumirá los costos adicionales en que incurriera el CLIENTE por el envió de los mensajes de texto con motivo de lo antes planteado.</p>

<h4 class=" tac-head">DÉCIMA OCTAVA: </h4>
<p>El BANCO, no concede ninguna licencia o autorización de uso de ninguna clase sobre sus derechos de propiedad intelectual o sobre cualquier otra propiedad o derecho relacionado con el SERVICIO.</p>

<h4 class=" tac-head">DÉCIMA NOVENA: </h4>
<p>El BANCO se reserva el derecho de modificar total o parcialmente las presentes Condiciones Generales, previa notificación a los CLIENTES con una antelación mínima de treinta (30) días continuos. Dentro del referido plazo el CLIENTE podrá rechazar, por escrito, las modificaciones incorporadas al presente documento por el BANCO, procediendo a su desafiliación automática.</p>

<h4 class=" tac-head">VIGÉSIMA: </h4>
<p>De conformidad con lo dispuesto en las “Normas Relativas a la Protección de los Usuarios y Usuarias de los Servicios Financieros” dictadas por la Superintendencia de las Instituciones del Sector Bancario, mediante Resolución N° 083.11 de fecha quince (15) de marzo de 2011, el BANCO hará entrega al CLIENTE con anterioridad de un (1) ejemplar de las presentes Condiciones Generales, en tal sentido, éste dispondrá del tiempo suficiente para examinar su contenido y comprender el exacto alcance, trascendencia y consecuencias jurídicas de todas y cada una de las Cláusulas que las conforman, las cuales aceptará sin reparo u objeción alguna, por constituir las mismas reflejo fiel y exacto de su voluntad.</p>

<h4 class=" tac-head">VIGÉSIMA PRIMERA: </h4>
<p>Para todos los efectos, derivados y consecuencias de éstas Condiciones Generales se elige como domicilio especial la ciudad del domicilio del CLIENTE, a la jurisdicción de cuyos Tribunales someten la resolución de las controversias que se pudiesen suscitar con ocasión del SERVICIO, sin perjuicio para el BANCO de ocurrir a otros Tribunales competentes de conformidad con la Ley.</p>

<h4 class=" tac-head">VIGÉSIMA SEGUNDA: </h4>
<p>Las presentes Condiciones Generales entran en vigencia a partir de la fecha de su autenticación, sustituyendo en todas y cada una de sus partes, a partir de esa fecha a las CONDICIONES GENERALES DEL SERVICIO BANESCOMÓVIL, contenidas en documento debidamente protocolizado ante el Registro Público del Segundo Circuito del Municipio Baruta Estado Miranda, en fecha veintiséis (26) de julio de 2010, bajo el N° 29, Tomo 11, Protocolo de Transcripción.</p>

<p>Documento autenticado por ante la Notaría Tercera del Municipio Baruta del Estado Miranda, en fecha nueve (09) de septiembre de 2011, bajo el N° 44, Tomo 98, de los libros de autenticaciones llevados por dicha Notaría.</p>
