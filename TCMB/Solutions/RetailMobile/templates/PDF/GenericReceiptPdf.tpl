...
<tr><td bgcolor="ffffff"><font size="8"><strong>Date:&nbsp;</strong></font> <font size="7">$$DownloadPaymentDetails[1].Date$ </font></td></tr>
<tr><td bgcolor="ffffff"><font size="8"><strong>Time:&nbsp;</strong></font> <font size="7">$$DownloadPaymentDetails[1].Time$ </font></td></tr>
</table>
<br />

<font size="9">
<table width="100%" border="0" bordercolor="ffffff" cellspacing="2" cellpadding="2">
<tr><td bgcolor="ffffff"><strong>PAYMENT DETAILS</strong></td></tr>
</table>
</font>
...
$%for 1 to DownloadPaymentDetails[1].PaymentDetails.lastInstance() $
  <tr>
    <td bgcolor="ffffff"><font size="8">$$DownloadPaymentDetails[1].PaymentDetails[C].itemName$</font></td>
    <td bgcolor="ffffff"><font size="7">$$DownloadPaymentDetails[1].PaymentDetails[C].itemValue$</font></td>
  </tr>
$%endfor$
</table>
<br />
