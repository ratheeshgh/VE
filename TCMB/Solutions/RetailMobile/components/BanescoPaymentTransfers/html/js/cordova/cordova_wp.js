    ...
    fireDocumentEvent: function(type, data, bNoDetach) {
        ...
        if (typeof documentEventHandlers[type] != 'undefined') {
            if( bNoDetach ) {
                ...
                setTimeout(function() {
                    // Fire deviceready on listeners that were registered before cordova_wp.js was loaded.
                    if (type == 'deviceready') {
...
// Wrap in a setTimeout to support the use-case of having plugin JS appended to cordova_wp.js.
...
// Handler for the cordova_plugins_wp.js content.
...
exports.load = function(callback) {
    ...
    if (pathPrefix === null) {
        console.log('Could not find cordova_wp.js script tag. Plugin loading may fail.');
        pathPrefix = '';
    }
    injectIfNecessary('cordova/plugin_list', pathPrefix + 'cordova_plugins_wp.js', function() {
